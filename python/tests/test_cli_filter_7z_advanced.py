...
def test_filter_7z_pick_filter_feature_id():
    ...
    with runner.isolated_filesystem() as td:
        ...
        with open("test.geojsonl", "w") as f:
            ...
            f.write(
                '{"type": "Feature", "geometry": {"type": "Point", "coordinates": [6, 6]}, '
                '"properties": {"name": "Feature2"}}\n'
            )
            f.write(
                '{"type": "Feature", "geometry": {"type": "Point", "coordinates": [11, 11]}, '
        ...
        with open("filtered_0.geojsonl") as f:
        ...
        with open("filtered_1.geojsonl") as f:
        ...
        with open("filtered_2.geojsonl") as f:
        ...
        result_out_of_bounds = runner.invoke(
            main_cli,
            [
                "cli",
                "filter-7z",
...
def test_filter_7z_pick_filter_feature_kv():
    ...
    with runner.isolated_filesystem() as td:
        ...
        with open("test.geojsonl", "w") as f:
            f.write(
                '{"type": "Feature", "geometry": {"type": "Point", "coordinates": [1, 1]}, '
                '"properties": {"name": "FeatureA"}}\n'
            )
            f.write(
                '{"type": "Feature", "geometry": {"type": "Point", "coordinates": [6, 6]}, '
                '"properties": {"name": "FeatureB"}}\n'
            )
            f.write(
                '{"type": "Feature", "geometry": {"type": "Point", "coordinates": [11, 11]}, '
                '"properties": {"name": "FeatureC"}}\n'
            )
            f.write(
                '{"type": "Feature", "geometry": {"type": "Point", "coordinates": [16, 16]}, '
                '"properties": {"name": "FeatureD"}}\n'
            )
        ...
        with open("filtered_first.geojsonl") as f:
        ...
        with open("filtered_second.geojsonl") as f:
        ...
        result_int_value = runner.invoke(
            main_cli,
            [
                "cli",
                "filter-7z",
        ...
        with open("filtered_int_value.geojsonl") as f:
        ...
        with open("filtered_third.geojsonl") as f:
        ...
        result_non_existent = runner.invoke(
            ...
            [
                ...
                "test.7z",
                "-o",
                "filtered_non_existent.geojsonl",
                "-f",
                "filter.geojson",
                "--pick-filter-feature-kv",
                "value=999",
        ...
        result_duplicate = runner.invoke(
            main_cli,
            [
                "cli",
                "filter-7z",
                ...
                "test.7z",
                "-o",
                "filtered_duplicate.geojsonl",
                "-f",
                "filter_duplicate.geojson",
                "--pick-filter-feature-kv",
